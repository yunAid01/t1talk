...
import { useUpdatePasswordMutation } from '@/hooks/user/useUpdatePasswordMutation';

export default function UpdatePasswordConfirmModal() {
  ...
  const currentPassword = modalProps?.currentPassword;
  const newPassword = modalProps?.newPassword;
